...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Mr.Qi/FutureRequest'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Mr.Qi' => 'qizengkui@clxkj.cn' }
  s.source           = { :git => 'https://github.com/Mr.Qi/FutureRequest.git', :tag => s.version.to_s }
